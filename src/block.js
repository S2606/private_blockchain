...
class Block {
    ...
    validate() {
        ...
        return new Promise((resolve, reject) => {
            ...
            let recalculatedHash = SHA256(JSON.stringify({...self, "hash":null})).toString();
            let isBlockValid = currentBlockHash === recalculatedHash;
    ...
    getBData() {
        ...
        return new Promise((resolve, reject) => {
            ...
            if(self.height > 0){
                ...
                reject(new Error('Genesis Block Found'));
            }
        });
    }
